...
public class ProductViewDetailsAdapter extends RecyclerView.Adapter<ProductViewDetailsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductViewDetailsAdapter.ViewHolder holder, int position) {
        holder.productItems.setText(productDetails.get(position).productDetailsText);
        holder.productUnit.setText(productDetails.get(position).productDetailsUnit);
        holder.productMrp.setText(productDetails.get(position).productDetailsMrp);
            ...
            productImg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(position != RecyclerView.NO_POSITION){
                        ...
                        bundle.putString("viewProductName", clickedItem.productDetailsText);
                        bundle.putString("viewProductUnit", clickedItem.productDetailsUnit);
                        bundle.putString("viewProductMrp", clickedItem.productDetailsMrp);
